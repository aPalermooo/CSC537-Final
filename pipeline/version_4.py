...
dataset_path = os.path.join(project_root, 'datasets', 'character_classification', 'data', 'train')

num_classes = len([d for d in os.listdir(dataset_path)
                   if os.path.isdir(os.path.join(dataset_path, d))])

classification_model_path = os.path.join(project_root, 'results', 'character_classification', 'training_loop_v3', 'checkpoint', 'checkpoint_330.pth')
